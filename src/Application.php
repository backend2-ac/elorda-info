    ...
    AuthorizationServiceProviderInterface
{
    ...
    public function middleware(MiddlewareQueue $middlewareQueue): MiddlewareQueue
    {
        ...
        $csrf->skipCheckCallback(function($request) {            // Token check will be skipped when callback returns `true`.
            ...
            if ( $action == 'checkresponse' || $action == 'checkresponsetariff' || $action == 'checkresponsebases' ) {    // Skip token check for API URLs.
                return true;
            }
            return false;
        });
    ...
    public function getAuthenticationService(ServerRequestInterface $request): AuthenticationServiceInterface
    {
        ...
        $authenticationService->loadAuthenticator('Authentication.Form', [
            ...
            'loginUrl' => [
                ...
                Router::url('/kz/users/login'),
                Router::url('/en/users/login'),
            ],
        ]);
