    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="/admin/documents/add?lang=ru" class="btn btn-success">Добавить (RU)</a>
                <a href="/admin/documents/add?lang=kz" class="btn btn-success">Добавить (KZ)</a>
            </div>
        </div>
                    ...
                    <?php foreach($data as $item): ?>
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-info btn-sm" href="/admin/documents/edit/<?=$item['id']?>?lang=en">
                                    <i class="fas fa-pencil-alt"></i> eng
                                </a>
