         	...
         	<?php foreach($data as $item): ?>
              ...
              <td>
        			...
        			<td class="project-actions text-right">
        				<a class="btn btn-info btn-sm" href="/admin/branches/edit/<?=$item['id']?>?lang=ru">
                  <i class="fas fa-pencil-alt"></i> rus
                </a>
                <a class="btn btn-info btn-sm" href="/admin/branches/edit/<?=$item['id']?>?lang=kz">
                  <i class="fas fa-pencil-alt"></i> kaz
                </a>
        				<?php echo $this->Form->postLink('Удалить', "/admin/branches/delete/{$item['id']}", array('confirm' => 'Удалить Материал?', 'value'=>'465', 'class' => 'btn btn-danger btn-sm')) ?>
        			</td>
        		</tr>
        	<?php endforeach ?>
        </tbody>
