         	...
         	<?php foreach($data as $item): ?>
              ...
              <td>
                ...
                <td>
                    ...
                    <img src="<?= file_exists('/var/www/vhosts/elorda.info/httpdocs/webroot/img/articles' . $item['img_path']) ? '/img/articles' . $item['img_path'] : '/img/articles/thumbs/' . $item['img'] ?>" alt="" width="150">
                </td>
              <td>
