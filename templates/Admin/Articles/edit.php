...
//                    ?>
                    ...
                    <div class="form-group col_4">
                        ...
                        <div class="input-group date col-3" id="articles_publish_start_at" data-target-input="nearest">
                            <?= $this->Form->text('publish_start_at', array('class' => 'form-control datetimepicker-input', 'data-target' => '#articles_publish_start_at', 'value' => $data['publish_start_at'] ? $this->Time->format($data['publish_start_at'], 'Y-MM-dd HH:mm') : '' )); ?>
