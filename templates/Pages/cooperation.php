                ...
                <div class="block">
                    <section class="preview">
                        ...
                        <div class="preview__container">
                            ...
                            <div class="preview__title">Media kit новостного портала Elorda info</div>
                            <div class="preview__date">2023</div>
                        </div>
                    </section>
                    <section class="stats">
                        <div class="stats__container">
                            <h2 class="stats__title title">Статистика на сайте <span>в месяц</span></h2>
                            <div class="stats__items">
                                <div class="stats__item">
                                    <div class="stats__item-header">На сайте каждый месяц</div>
                                    <div class="stats__item-counter">52%</div>
                                    <div class="stats__item-text">новых посетителей</div>
                                ...
                                <form action="">
                                    <div class="stats__form">
                                        <div class="stats__form-title">Оставьте заявку на сотрудничество</div>
                                        <div class="stats__form-text">Разместите рекламу на нашем сайте, чтобы гарантировать себе просмотры и постоянных читателей. Оставьте свои контактные данные и мы с вами свяжемся для обсуждения деталей</div>
                    ...
                    <section class="follower">
                        <div class="follower__container">
                            <h2 class="follower__title title">Подписчики в социальных сетях</h2>
                            <div class="follower__items">
                                <div class="follower__item">
                                    <div class="follower__item-img">
                                        <img src="/img/f-1.png" alt="">
                                    </div>
                                    <div class="follower__item-title">Страница</div>
                            ...
                            <div class="follower__total">
                                <div class="follower__total-text">Всего подписчиков:</div>
                    ...
                    <section class="place">
                        <div class="place__container">
                            <h2 class="place__title title">Места на сайте</h2>
                    ...
                    <section class="brand">
                        <div class="brand__container">
                            <h2 class="brand__title title">С кем мы сотрудничаем</h2>
                        ...
                        <div class="feedback__container">
                            <form action="">
                                <div class="feedback__form">
                                    ...
                                    <h2 class="feedback__title title">Оставьте заявку на сотрудничество</h2>
                                    <div class="feedback__text">Оставьте свои контактные данные и мы с вами свяжемся для обсуждения деталей</div>
                                    ...
                                    <div class="contact__info">
                                        ...
                                        <ul class="contact__info-list">
                                            <li>
                                                ...
                                                <span>г.Астана, ул. Достык,13 ЖК "Нурсая-2</span>
                                            </li>
                                            <li>
                                                <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="contact__info-text">
                                            По вопросам сотрудничества и рекламы обращайтесь на почту: <a href="mailto:">Elorda.info2023@gmail.com</a>
                                        </div>
                                        ...
                                        <a href="#" target="_blank" class="contact__info-path">Как добраться?</a>
                                    </div>
                                    <div class="contact__map">
                                        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ad7c237fd456ad35da7b5f965f3f549910ce2b66ca0d444931a6351a8e484505e&amp;source=constructor" width="100%" height="400" frameborder="0"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
