...
<!--                    <a href="mailto:--><?php //= $comps[6]['body'] ?><!--" class="footer__mail">--><?php //= $comps[6]['body'] ?><!--</a>-->
                    ...
                    <div class="footer__text">
                        <?php if ($l == 'kz'): ?>
                        <span>10.03.2017 жылғы № 16386-СИ мерзімді баспасөз басылымын, ақпараттық агенттікті және желілік басылымды есепке қою, қайта есепке қою туралы куәлік.</span>
                        <?php else: ?>
                        <span>Свидетельство о постановке на учет, переучет периодического печатного издания, информационного агентства и сетевого издания № 16386-СИ выдано 10.03.2017 года.</span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
