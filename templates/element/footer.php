...
<!--                    <a href="mailto:--><?php //= $comps[6]['body'] ?><!--" class="footer__mail">--><?php //= $comps[6]['body'] ?><!--</a>-->
                    ...
                    <div class="footer__text">
                        <span><?= __('10.03.2017 жылғы № 16386-СИ мерзімді баспасөз басылымын, ақпараттық агенттікті және желілік басылымды есепке қою, қайта есепке қою туралы куәлік.') ?></span>
                    </div>
                </div>
            </div>
